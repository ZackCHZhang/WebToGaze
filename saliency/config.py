...
DIMS = {
    ...
    "image_size_gazemining": (240, 320),
    "image_size_eyevedo": (240, 320),
    "image_size_eyevedowithmask": (216, 384),
    "image_size_eyevedowithdoublemask":(216, 384),
    "image_size_alldataset": (240, 320),
    "image_size_alldatasetwithmask": (216, 384),
    "image_size_alldatasetwithdoublemask": (240, 320)
}
